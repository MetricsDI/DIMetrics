...
def main(GT_DIR, PRED_DIR, LineItemPrefix, address_labels, save_dir):
    os.makedirs(save_dir, exist_ok=True)

    final_df, file_num, gt_hed_lists, pred_hed_lists = get_merged_df_layoutlm(PRED_DIR, GT_DIR, LineItemPrefix,
                                                                              address_labels, line_threshold=25,
                                                                              cord=True)
...
if __name__ == "__main__":
    ...
    save_dir = "../outputs"
    start = time.time()
    main(GT_DIR, PRED_DIR, LineItemPrefix, address_labels, save_dir)
