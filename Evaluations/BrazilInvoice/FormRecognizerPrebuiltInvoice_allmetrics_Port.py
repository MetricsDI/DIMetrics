...
def main(GT_DIR, PRED_DIR, multiplier, LineItemPrefix, field_mapping, save_dir):
    os.makedirs(save_dir, exist_ok=True)

    final_df, file_num, gt_hed_lists, pred_hed_lists = get_merged_df_FR(PRED_DIR, GT_DIR, False, field_mapping,
                                                                        LineItemPrefix, multiplier)
    ...
    doc_hed_mean_df = get_hed_document(gt_hed_lists, pred_hed_lists)
...
if __name__ == "__main__":
    ...
    save_dir = "../outputs"
    start = time.time()
    main(GT_DIR, PRED_DIR, multiplier, LineItemPrefix, field_mapping, save_dir)
